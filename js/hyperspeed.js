...
class Hyperspeed {
    constructor(containerId, effectOptions = {}) {
        ...
        this.app = new App(this.container, this.options);
...
document.addEventListener('DOMContentLoaded', () => {
    console.log('Initializing Hyperspeed background...');
    const containerId = 'hyperspeed-container';
    ...
    const hyperspeed = new Hyperspeed(containerId, {
        // You can customize options here if needed, or use defaults
        colors: {
            roadColor: 0x080808,
            islandColor: 0x0a0a0a,
            background: 0x000000,
